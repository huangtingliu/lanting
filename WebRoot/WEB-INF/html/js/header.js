	...
	var Obanner = document.getElementById('banner');
			...
			//window.parent['headeriframe'].setAttribute('style','height:'+headeriframe+'px');
		 	...
		 	for(var i=1; i<=img_time ; i++){
		 		...
		 		banner_li.setAttribute('style',"background:url(images/background"+i+".jpeg) 50% 0 no-repeat;");   
...
function headerHtml(){
	...
	html += '	<div class="logo">';
	html += '		<img src="images/LOGO3.png">';
	html += '	</div>';
	html += '	<div class="nav">';
	html += '		<ul>';
	html += '			<li><a href="index.html">首页</a></li>';
	html += '			<li><a href="product_display.html">产品展示</a></li>';
	html += '			<li><a href="about-us.html">关于我们</a></li>';
	html += '			<li><a href="contact-us.html">联系我们</a></li>';
	html += '		</ul>';
	html += '	</div>';
	html += '</div> ';
